...
function Output({ sectionData, specificLaw,showSaveRL, onRemove, showDelete }) {
  // const sectionData = useRecoilValue(responseAtom); //[{},{},{}]
  // const specificLaw = useRecoilValue(specificLawTypeAtom); //ipc,cpc
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          `http://localhost:3000/v1/law/${lawType}/${specificLaw}?sections=${sectionNum.join(
            "&sections="
          )}`
        );
